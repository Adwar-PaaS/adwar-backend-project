...
// import { CsrfExempt } from 'src/common/decorators/csrf-exempt.decorator';
// import { CsrfRequest } from 'src/common/middleware/csrf.middleware';
// import { DomainAccessGuard } from 'src/common/guards/domain-access.guard';
...
//   @Post('login')
//   @UseGuards(CsrfGuard, DomainAccessGuard)
//   @Throttle({ default: { limit: 5, ttl: seconds(60) } })
//   async login(
//     @Body() dto: LoginDto,
//     @Req() req: AuthenticatedRequest,
...
//   @Post('refresh')
//   @UseGuards(SessionGuard, CsrfGuard, DomainAccessGuard)
//   @Throttle({ default: { limit: 20, ttl: seconds(300) } })
//   async refresh(
//     @Req() req: AuthenticatedRequest,
//   ): Promise<APIResponse<{ user: AuthUser }>> {
